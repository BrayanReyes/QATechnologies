...
/**
 * Booking Home Page handle the main options in BookingTest.com page
 * (Dormir, Vuelos, Alquiler de coches, Atracciones turísticas and Taxis
 * aeropuerto) also, other features like Registra tu alojamiento, Hazte una
 * cuenta and Iniciar sesión.
 *
 * @author: july.moreno
 * @version: 24/06/2020
 *

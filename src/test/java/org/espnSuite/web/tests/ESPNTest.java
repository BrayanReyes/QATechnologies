...
public class ESPNTest extends BaseTest {
	...
	@BeforeMethod(description = "Create user account")
...
//	}
	...
	// **July paso por aqui**//
	@AfterMethod(description = "After LogIn")
	...
	@BeforeMethod(description = "Antes de Log Out")
	...
	// **July paso por aqui**//
	@AfterMethod(description = "Despues de Log Out")
	...
	// **July paso por aqui**//
	@BeforeMethod(description = "Antes de Delete")

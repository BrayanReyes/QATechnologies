...
/**
 * Review And Book Page shows the details about the vacational package chosen
 * through the process of selecting the hotel, the departing and returning
 * flights. Also, allows to select additional services like transportation.
 */

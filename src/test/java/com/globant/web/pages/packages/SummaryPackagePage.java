...
/**
 * Summary Package Page shows the whole vacational package information and
 * allows to enter the payment information.
 */
...
public class SummaryPackagePage extends BasePage {
	...
	private static final String ADD_CAR_BUTTON_CSS = ".gt-add-btn";
	...
	public void clickAddCarToTripButton() {
		if (transportationModule.isDisplayed() && transportationModule.isEnabled()) {
			List<WebElement> addCarButtonList = transportationModule.findElements(By.cssSelector(ADD_CAR_BUTTON_CSS));

...
/**
 * Flights Search Page handles the process to search a flight according with
 * parameters like: Flying from, Flying to, Departing and Returning Dates and
...
public class FlightsSearchPage extends BasePage {
	...
	/**
	 * Click on Search Button and go to Flights Result Page
	 */

...
/**
 * Cruises Test handles the process of booking a cruise till the cabin page
 */

public class CruisesTest extends BaseTest {

	@Test(description = "Booking a Cruise", dataProvider = "InputCruisesData", dataProviderClass = com.globant.web.data.DataInit.class)
	public void bookingCruiseTest(CruisesParameters cruisesParameters) {
		...
		log.info("---------- Booking a Cruise till the cabin page works correctly ----------");

...
public class CruisesTest extends BaseTest {
    ...
    public void bookingCruiseTest(CruisesParameters cruisesParameters) {
        ...
        cruisesPage.setDepartingDate(cruisesParameters.getDaysForward());
        cruisesPage.setReturningDate(cruisesParameters.getStayDuration());
...
//        log.info("Departing Date: " + cabinPage.getSailingDepartingDate());
//        log.info("Returning Date: " + cabinPage.getSailingReturningDate());
